...
//print '<div class="gist-main">';
    ...
    print '<div class="gist-container" style="padding: 0px;">';
        print '<ol class="breadcrumb">';
            ...
            print '<li class="breadcrumb-item"><a href="profile?guser='.$_GET['guser'].'">'.$_GET['guser'].'</a></li>';
            print '<li class="breadcrumb-item"><a href="#">followings</a></li>';
        print '</ol>';
    print '</div>';

//    print '<div class="header3"><h3>Your Followings</h3></div>';
    $uFJson =json_decode($uF->getByFollowerId($_GET['guid']));
    if(sizeof($uFJson->following) > 0):
        ...
        {
            $u = new User();
            $userJson = json_decode($u->getById($uFJson->following[$i]->followed_id));
                ...
                print '<li class="list-group-item">';
                    print '<div class="media w-100">';
                        ...
                        if(sizeof($getFollowedId->following) > 0):
                            if($uFJson->following[$i]->followed_id === $userJson->users[$j]->id):
        ...
        print '<div class="gist-container" style="background: transparent;box-shadow: none;text-align: center;color: #CCC;">';
            print '<h1 style="width: 70%;margin: 10px auto;">You are not following anyone....!!!</h1>';
        print '</div>';
    endif;
//print '</div>';